...
namespace AmazonSellingPartner\Api\ProductPricingApi;
...
use AmazonSellingPartner\HttpFactory;
use AmazonSellingPartner\HttpSignatureHeaders;
...
final class ProductPricingSDK implements ProductPricingSDKInterface
{
     ...
     */
    public function getCompetitivePricing(AccessToken $accessToken, string $region, string $marketplace_id, string $item_type, ?array $asins = null, ?array $skus = null, ?string $customer_type = null) : \AmazonSellingPartner\Model\ProductPricing\GetPricingResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\ProductPricing\GetPricingResponse',
            []
        );
    }
     ...
     * @param null|string $customer_type Indicates whether to request pricing information from the point of view of Consumer or Business buyers. Default is Consumer. (optional)
     *
     * @throws \AmazonSellingPartner\Exception\InvalidArgumentException
     */
     ...
     * @throws InvalidArgumentException
     */
    public function getItemOffers(AccessToken $accessToken, string $region, string $marketplace_id, string $item_condition, string $asin, ?string $customer_type = null) : \AmazonSellingPartner\Model\ProductPricing\GetOffersResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\ProductPricing\GetOffersResponse',
            []
        );
    }
     ...
     *
     * @param \AmazonSellingPartner\Model\ProductPricing\GetItemOffersBatchRequest $get_item_offers_batch_request_body get_item_offers_batch_request_body (required)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException
     */
    public function getItemOffersBatch(AccessToken $accessToken, string $region, \AmazonSellingPartner\Model\ProductPricing\GetItemOffersBatchRequest $get_item_offers_batch_request_body) : \AmazonSellingPartner\Model\ProductPricing\GetItemOffersBatchResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\ProductPricing\GetItemOffersBatchResponse',
            []
        );
    }
     ...
     *
     * @param \AmazonSellingPartner\Model\ProductPricing\GetItemOffersBatchRequest $get_item_offers_batch_request_body (required)
     *
     * @throws \AmazonSellingPartner\Exception\InvalidArgumentException
     */
    public function getItemOffersBatchRequest(AccessToken $accessToken, string $region, \AmazonSellingPartner\Model\ProductPricing\GetItemOffersBatchRequest $get_item_offers_batch_request_body) : RequestInterface
    {
     ...
     * @throws InvalidArgumentException
     */
    public function getListingOffers(AccessToken $accessToken, string $region, string $marketplace_id, string $item_condition, string $seller_sku, ?string $customer_type = null) : \AmazonSellingPartner\Model\ProductPricing\GetOffersResponse
    {
     ...
     *
     * @param \AmazonSellingPartner\Model\ProductPricing\GetListingOffersBatchRequest $get_listing_offers_batch_request_body get_listing_offers_batch_request_body (required)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException
     */
    public function getListingOffersBatch(AccessToken $accessToken, string $region, \AmazonSellingPartner\Model\ProductPricing\GetListingOffersBatchRequest $get_listing_offers_batch_request_body) : \AmazonSellingPartner\Model\ProductPricing\GetListingOffersBatchResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\ProductPricing\GetListingOffersBatchResponse',
            []
        );
    }
     ...
     *
     * @param \AmazonSellingPartner\Model\ProductPricing\GetListingOffersBatchRequest $get_listing_offers_batch_request_body (required)
     *
     * @throws \AmazonSellingPartner\Exception\InvalidArgumentException
     */
    public function getListingOffersBatchRequest(AccessToken $accessToken, string $region, \AmazonSellingPartner\Model\ProductPricing\GetListingOffersBatchRequest $get_listing_offers_batch_request_body) : RequestInterface
    {
     ...
     * @throws InvalidArgumentException
     */
    public function getPricing(AccessToken $accessToken, string $region, string $marketplace_id, string $item_type, ?array $asins = null, ?array $skus = null, ?string $item_condition = null, ?string $offer_type = null) : \AmazonSellingPartner\Model\ProductPricing\GetPricingResponse
    {
