...
class GetListingOffersBatchRequest implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'requests' => '\AmazonSellingPartner\Model\ProductPricing\ListingOffersRequest[]',
    ];
     ...
     * Gets requests.
     *
     * @return null|\AmazonSellingPartner\Model\ProductPricing\ListingOffersRequest[]
     */
     ...
     * Sets requests.
     *
     * @param null|\AmazonSellingPartner\Model\ProductPricing\ListingOffersRequest[] $requests a list of `getListingOffers` batched requests to run
     */
