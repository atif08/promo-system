...
class GetItemOffersBatchRequest implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'requests' => '\AmazonSellingPartner\Model\ProductPricing\ItemOffersRequest[]',
    ];
     ...
     * Gets requests.
     *
     * @return null|\AmazonSellingPartner\Model\ProductPricing\ItemOffersRequest[]
     */
     ...
     * Sets requests.
     *
     * @param null|\AmazonSellingPartner\Model\ProductPricing\ItemOffersRequest[] $requests a list of `getListingOffers` batched requests to run
     */
