...
class ItemRelationship implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'child_asins' => 'string[]',
        'parent_asins' => 'string[]',
        'variation_theme' => '\AmazonSellingPartner\Model\CatalogItem\ItemVariationTheme',
        'type' => 'string',
    ];
     ...
     *
     * @param null|\AmazonSellingPartner\Model\CatalogItem\ItemVariationTheme $variation_theme variation_theme
     */
