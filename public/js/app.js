(function ($) {
    $(document).ready(function () {
        var theme = $("body").attr("data-layout-mode");
        if (theme === "dark") {
            $(".switch-theme .radio-btn input#dark").prop("checked", true);
            $("body").attr({
                "data-sidebar": "dark",
            ...
            $(".switch-theme .radio-btn input#light").prop("checked", true);
            $("body").attr({
                "data-sidebar": "light",
    ...
    $(".switch-theme .radio-btn").click(function () {
    ...
    function updateThemeSetting(id) {
        ...
        if (
            ...
            $("#bootstrap-style").attr(
                "href",
                "css/bootstrap-dark-rtl.min.css"
            );
