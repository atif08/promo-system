!(function (i) {
  ...
  (o = 0),
          ...
          (t.$slides
            ...
            .each(function (i) {
              ...
              a(this).attr({
                ...
                -1 !== e &&
                  ((e = "slick-slide-control" + t.instanceUid + e),
                  a("#" + e).length && a(this).attr({ "aria-describedby": e }));
            }),
          t.$dots
            .attr("role", "tablist")
            .find("li")
    ...
    (r.prototype.selectHandler = function (i) {
      var i = a(i.target).is(".slick-slide")
          ? a(i.target)
        ...
        return (
          ...
          (!1 === r.options.infinite &&
            ...
            : (r.options.autoplay && clearInterval(r.autoPlayTimer),
              ...
              r.options.asNavFor &&
                (e = (e = r.getNavTarget()).slick("getSlick")).slideCount <=
              ...
              !0 === r.options.fade
                ...
                : void (!0 !== t && r.slideCount > r.options.slidesToShow
      ...
      return (
        ...
        !o.options.verticalSwiping && !o.swiping && 4 < t
          ...
          : (!0 === o.options.verticalSwiping &&
            ...
            !1 === o.options.vertical
              ? (o.swipeLeft = e + i * t)
              : (o.swipeLeft = e + i * (o.$list.height() / o.listWidth) * t),
