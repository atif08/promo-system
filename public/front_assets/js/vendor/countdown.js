!(function (c) {
  ...
  (c.fn.showclock = function () {
    var n = new Date(),
      ...
      s = [0, 0];
    if (
      (null != c(this).data("time") && (s = c(this).data("time").split(":")),
      (a =
        new Date(o[0], o[1] - 1, o[2], s[0], s[1]).getTime() / 1e3 -
    ...
    0 != t &&
      ...
      (n += "<span class='countdown-heading days-top'>Days</span>"),
      (n += "</div>")),
      (n += "<div class='countdown-container hours'>"),
      (n += "<span class='countdown-value hours-bottom'>" + e(o) + "</span>"),
      (n += "<span class='countdown-heading hours-top'>Hours</span>"),
      (n += "</div>"),
      ...
      (n += "<span class='countdown-heading seconds-top'>Secs</span>"),
      this.html((n += "</div>"));
  }),
