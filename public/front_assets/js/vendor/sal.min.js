!(function (e, t) {
  ...
  return (() => {
    ...
    r.d(e, { default: () => O });
    function a(e, t) {
      (e = new CustomEvent(e, { bubbles: !0, detail: t })),
      ...
      m = function (e, o) {
        e.forEach(function (e) {
          ...
          e.intersectionRatio >= l.threshold
            ? ((r = e).target.classList.add(l.animateClassName),
              a(l.enterEventName, r),
              n || o.unobserve(t))
            : n && (f((e = e).target), a(l.exitEventName, e));
        });
      },
      v = function () {
        var e = [].filter.call(
          ...
          function (e) {
            return (
              l.animateClassName, !e.classList.contains(l.animateClassName)
            );
          }
        );
        return (
    ...
    const O = function () {
      if (
        (d(0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : l),
        "undefined" == typeof window)
      )
        return (
          console.warn("Sal was not initialised! Probably it is used in SSR."),
          { elements: c, disable: o, enable: y, reset: s, update: i }
        );
