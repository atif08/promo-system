...
(function(h) {
    ...
    function qb(a) {
        ...
        var i = h("<div><label><i class='fas fa-chevron-down'></i></label></div>").addClass(b.sLength);
    ...
    l.defaults = {
        ...
        oLanguage: {
            ...
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "_MENU_ Show on page",
...
(function(g) {
    ...
    function x(a) {
        r === p && (r = -1 === v.serializeToString(g.parseXML(q["xl/worksheets/sheet1.xml"])).indexOf("xmlns:r"));
    ...
    var y = function(a, b) {
        ...
        A = function(a, b) {
            for (var d = z(b), c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, f = b.fieldSeparator, g = RegExp(e, "g"), i = b.escapeChar !== p ? b.escapeChar : "\\", j = function(a) {
                    for (var b = "", c = 0, d = a.length; c < d; c++) 0 < c && (b += f), b += e ? e + ("" + a[c]).replace(g, i + e) + e : a[c];
                    return b
                }, m = b.header ? j(c.header) + d : "", o = b.footer && c.footer ? d + j(c.footer) : "", n = [], l = 0, h = c.body.length; l < h; l++) n.push(j(c.body[l]));
            return {
                str: m + n.join(d) +
                    o,
                rows: n.length
        ...
        v = "",
        v = "undefined" === typeof j.XMLSerializer ?
        new function() {
    ...
    h.ext.buttons.excelFlash = g.extend({}, u, {
        ...
        action: function(a, b, d, c) {
            ...
            var a = c._flash,
                ...
                j, m, h = function(a) {
                    ...
                    for (var b = 0, d = a.length; b < d; b++) {
                        ...
                        h || ("number" === typeof a[b] || a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/) ? h = o(f, "c", {
                            attr: {
                                t: "n",
                                r: g
                            },
                        ...
                        }) : (l = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ""), h = o(f, "c", {
                            attr: {
                                t: "inlineStr",
                                r: g
                            },
            ...
            c.header && (h(k.header, e), g("row:last c",
                f).attr("s", "2"));
            ...
            n = 0;
            for (s = k.header.length; n < s; n++) h.appendChild(o(f, "col", {
                attr: {
                    min: n + 1,
                    max: n + 1,
                    width: C(k, n),
...
(function(e) {
    ...
    e.extend(m.prototype, {
        ...
        _constructor: function() {
            ...
            if (this.c.blurable) e(k).on("mousedown" + c, function(c) {
                e(c.target).parents(".dataTables_filter").length && a._blur();
                e(c.target).parents().filter(b.table().container()).length ||
                    e(c.target).parents("div.DTE").length || !e(c.target).parents("div.editor-datetime").length && !e(c.target).parents("div.dt-datetime").length && (e(c.target).parents().filter(".DTFC_Cloned").length || a._blur())
            });
            if (this.c.editor) {
                var i = this.c.editor;
                i.on("open.keyTableMain", function(b, d) {
                    "inline" !== d && a.s.enable && (a.enable(!1), i.one("close" + c, function() {
                        a.enable(!0)
                    }))
                });
                if (this.c.editOnFocus) b.on("key-focus" + c + " key-refocus" + c, function(b, c, d, f) {
                    a._editor(null, f, !0)
                });
            ...
            if (b.settings()[0].oFeatures.bStateSave) b.on("stateSaveParams" + c, function(b, c, d) {
            ...
            b.on("destroy" + c, function() {
                a._blur(!0);
                b.off(c);
                e(b.table().body()).off("click" + c, "th, td").off("dblclick" + c, "th, td");
                e(k).off("mousedown" + c).off("keydown" + c).off("copy" + c).off("paste" + c)
            });
        ...
        _clipboard: function() {
            var a = this.s.dt,
                b = this,
                d = this.s.namespace;
            j.getSelection && (e(k).on("copy" + d, function(a) {
                var a = a.originalEvent,
                    d = j.getSelection().toString(),
                    e = b.s.lastFocus;
                !d && e && (a.clipboardData.setData("text/plain",
                    e.cell.render(b.c.clipboardOrthogonal)), a.preventDefault())
                ...
                var c = c.originalEvent,
                    ...
                    g = b.c.editor,
                    h;
                if (d && (!e || "body" === e.nodeName.toLowerCase())) c.preventDefault(), j.clipboardData && j.clipboardData.getData ? h = j.clipboardData.getData("Text") : c.clipboardData && c.clipboardData.getData && (h = c.clipboardData.getData("text/plain")), g ? g.inline(d.cell.index()).set(g.displayed()[0], h).submit() : (d.cell.data(h), a.draw(!1))
            }))
        },
        _columns: function() {
            var a =
        ...
        _editor: function(a, b, d) {
            if (this.s.lastFocus && !(b && "draw" === b.type)) {
                ...
                if (!e("div.DTE", g.node()).length && !(null !== a && (0 <= a && 9 >= a || 11 === a || 12 === a || 14 <= a && 31 >= a || 112 <= a && 123 >= a || 127 <= a && 159 >= a))) {
                    ...
                    13 === a ? (d = !0, e(k).one("keyup", function() {
                        j()
                    })) : j()
                }
            }
        ...
        _focus: function(a, b, d, c) {
            ...
            if (this.s.enable) {
                ...
                if (-1 !== g.length && (a < g.start || a >= g.start + g.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, i.one("draw", function() {
                    f.s.focusDraw = !1;
                ...
                if (b && (!(0 === a.keyCode || a.ctrlKey || a.metaKey || a.altKey) || a.ctrlKey && a.altKey)) {
                    ...
                    if (c)
                        if (this.s.dt.cell(c.node).any()) {
                            ...
                            if (!(this.c.keys && -1 === e.inArray(a.keyCode,
                                    this.c.keys))) switch (a.keyCode) {
                                case 9:
                                ...
                                case 35:
                                case 36:
                                    d && (a.preventDefault(), b = c.cells({
                                        page: "current"
                                    }).indexes(), d = this._columns(), this._focus(c.cell(b[35 === a.keyCode ? b.length - 1 : d[0]]), null, !0, a));
                                    break;
                                case 37:
        ...
        _shift: function(a, b, d) {
            ...
            if (h) {
                ...
                j && ((h = c.rows({
                        filter: "applied",
                        order: "applied"
                    }).indexes().indexOf(j.index().row), f.serverSide && (h += f.start), c = c.columns(g).indexes().indexOf(j.index().column),
                    f = h, h = g[c], "right" === b ? c >= g.length - 1 ? (f++, h = g[0]) : h = g[c + 1] : "left" === b ? 0 === c ? (f--, h = g[g.length - 1]) : h = g[c - 1] : "up" === b ? f-- : "down" === b && f++, 0 <= f && f < i && -1 !== e.inArray(h, g)) ? (a && a.preventDefault(), this._focus(f, h, !0, a)) : !d || !this.c.blurable ? a && a.preventDefault() : this._blur())
            }
        },
        _tabInput: function() {
            var a = this,
                b = this.s.dt,
                d = null !== this.c.tabIndex ? this.c.tabIndex : b.settings()[0].iTabIndex; - 1 != d && (this.s.tabInput || (d = e('<div><input type="text" tabindex="' + d + '"/></div>').css({
                position: "absolute",
                height: 1,
                width: 0,
                overflow: "hidden"
            }), d.children().on("focus", function(c) {
                var d = b.cell(":eq(0)", a._columns(), {
                    page: "current"
                });
...
(function(e) {
    ...
    }) : "object" === typeof exports ? module.exports = function(i, j) {
        i || (i = window);
        if (!j || !j.fn.dataTable) j = require("datatables.net")(i, j).$;
        return e(j, i, i.document)
    } : e(jQuery, window, document)
})(function(e, i, j, h) {
    function u(a, c, b) {
        var d;
    ...
    function y(a) {
        ...
        e("body").on("click.dtSelect" + x(a.table().node()), function(c) {
    ...
    function r(a, c, b, d, f) {
        ...
        if (!h || g) "os" === e ? a.ctrlKey || a.metaKey ? c[d](f).select(!h) : a.shiftKey ? "cell" === d ? u(c, f, b._select_lastCell || null) : A(c, d, f, b._select_lastCell ? b._select_lastCell[d] : null) : (a = c[d + "s"]({
            selected: !0
        }), h && 1 === a.flatten().length ? c[d](f).deselect() : (a.deselect(), c[d](f).select())) : "multi+shift" == e ? a.shiftKey ? "cell" === d ? u(c, f, b._select_lastCell || null) : A(c, d, f, b._select_lastCell ? b._select_lastCell[d] : null) : c[d](f).select(!h) : c[d](f).select(!h)
    }
    ...
    m("select.toggleable()", function(a) {
        return a === h ? this.context[0]._select.toggleable : this.iterator("table", function(c) {
            c._select.toggleable = a
        })
    });
    m("select.info()", function(a) {
        return z === h ? this.context[0]._select.info : this.iterator("table", function(c) {
            c._select.info = a
        })
    });
    ...
    e(j).on("preInit.dt.dtSelect", function(a, c) {
